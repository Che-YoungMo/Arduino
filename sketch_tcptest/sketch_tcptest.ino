...
// TCP -------------------------------------------------
byte mac[] = { 0x74,0x69,0x69,0x2D,0x30,0x3 };
//byte Ethernet::buffer[700];
byte ip[] = { 192, 168, 100, 100 };  // Arduino IP
byte server[] = { 192, 168, 100, 3 }; // Server IP
int tcp_port = 7000;
  ...
  while (client.available() > 0)
  {
    ...
    else if (tcpStarted == true && tmpData == ETX)
    {
      ...
      if (tcpOpcode == OPCODE_1) {
        ...
        return true;
      }// else if (tcpOpcode == OPCODE_4) {
       // Serial.println("OPCODE_4");
       // return true;
      //}
      else {
